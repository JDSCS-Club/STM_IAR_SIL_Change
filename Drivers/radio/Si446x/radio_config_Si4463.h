...
// INPUT DATA
/*
// Crys_freq(Hz): 25000000    Crys_tol(ppm): 20    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0    ANT_DIV: 0    PM_pattern: 0    
// MOD_type: 0    Rsymb(sps): 10000    Fdev(Hz): 20000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 931    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 1    Hi_pfm_div: 1    
// API_ARR_Det_en: 0    Fdev_error: 0    API_ETSI: 0    
// 
// # RX IF frequency is  -390625 Hz
// # WB filter 3 (BW = 102.90 kHz);  NB-filter 3 (BW = 102.90 kHz)
// 
// Modulation index: 4
*/
...
#define RADIO_CONFIGURATION_DATA_RADIO_XO_FREQ                     25000000L
...
*/
#define RF_POWER_UP 0x02, 0x81, 0x00, 0x01, 0x7D, 0x78, 0x40
//#define RF_POWER_UP 0x02, 0x01, 0x00, 0x01, 0x7D, 0x78, 0x40
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x08, 0x00, 0x07, 0x01, 0x86, 0xA0, 0x01, 0x7D, 0x78, 0x40, 0x00, 0x03
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12 0x11, 0x20, 0x0C, 0x18, 0x00, 0x00, 0x08, 0x03, 0xC0, 0x00, 0x10, 0x10, 0x00, 0xE8, 0x01, 0xA1
...
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 0x11, 0x20, 0x0C, 0x24, 0x01, 0x3A, 0x93, 0x00, 0x4F, 0x02, 0x00, 0x00, 0x00, 0x12, 0x80, 0x34
...
*/
#define RF_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x06, 0xA7, 0xA0
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12 0x11, 0x20, 0x0C, 0x38, 0x11, 0x5B, 0x5B, 0x80, 0x02, 0xFF, 0xFF, 0x00, 0x2A, 0x0C, 0xA4, 0x23
...
*/
#define RF_MODEM_RAW_CONTROL_5 0x11, 0x20, 0x05, 0x45, 0x03, 0x01, 0x33, 0x01, 0x00
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x49, 0x0B, 0xD7, 0x0A, 0x28, 0xF6, 0x20, 0xFF
