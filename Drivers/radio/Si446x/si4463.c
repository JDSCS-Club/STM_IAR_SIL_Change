...
int8_t SI4463_GetFuncInfo( const si4463_t * si4463, uint8_t * pRxData )
{
	int8_t result = SI4463_OK;
	uint8_t cmdChain[1] = { SI4463_CMD_FUNC_INFO };

	result += SI4463_SendCommand( si4463, cmdChain, 1 );
	result += SI4463_ReadCommandBuffer( si4463, pRxData, 7 );
...
int8_t SI4463_GetChipStatus(si4463_t * si4463)
{
	...
	if((result == SI4463_OK) && (answer[1] == SI4463_BYTE_CTS))
	{
		si4463->chipStatus.cmdError = (si4463_cmd_err_status_t)answer[4];
		si4463->chipStatus.cmdErrCmdId = answer[5];
		result = SI4463_OK;
	}
	else
	{
		si4463->chipStatus.cmdError = (si4463_cmd_err_status_t)0xFF;
